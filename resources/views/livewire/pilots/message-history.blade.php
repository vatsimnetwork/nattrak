                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <p>
                                    from {{ \App\Models\ClxMessage::whereId($message['id'])->first()->datalink_authority->value }} ({{ \App\Models\ClxMessage::whereId($message['id'])->first()->datalink_authority->description() }})
                                </p>
                            </div>
                        </div>
                        <div>
                            ...
                            @else
                                <p class="fst-italic">Clearance withdrawn.</p>
                            @endif
                        </div>
                    </div>
                </div>
