...
@section('page')
    <div class="uk-container uk-padding uk-padding-remove-right uk-padding-remove-left">
        ...
        <p class="uk-text-meta">
            <span class="uk-text-bold">Do not add people who already have admin or above perms.</span> Showing users with controller access. Temporary controller access is also assigned when a user is logged onto an oceanic position. To add a user, use the form at the bottom of the page.
        </p>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="POST" action="{{ route('administration.controllers.remove-access') }}">
                                ...
                                <button class="uk-button uk-button-small" name="delete" type="submit">Remove controller access</button>
                            </form>
                        </td>
                    </tr>
                @endforeach
        ...
        <form action="{{ route('administration.controllers.add-access') }}" method="POST" class="uk-grid-small" uk-grid>
            @csrf
