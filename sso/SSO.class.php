...
class SSO
{
    ...
    public function requestToken($return_url = false, $allow_sus = false, $allow_ina = false)
    {
        ...
        $req = OAuthRequest::from_consumer_and_token($this->consumer, false, 'POST', $tokenUrl, [
    ...
    public function checkLogin($tokenKey, $tokenSecret, $tokenVerifier)
    {
        ...
        $req = OAuthRequest::from_consumer_and_token($this->consumer, $this->token, 'POST', $returnUrl, [
